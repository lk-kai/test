          ...
          <Content :style="{ padding: '24px', background: '#fff' }">
            <Row style="height:66px;line:height:66px" class="row1">
              ...
              <Col :xs="24" :sm="24" :md="12" :lg="8"
                ><Button type="primary" class="button" @click="addsell">新增寄卖商</Button
                ><Button type="primary" class="button" @click="a">新增分销商</Button>
                <Button type="primary" class="button">导出Excel</Button></Col
              >
            </Row>
            <Row :gutter="10">
              <Col span=""
                ><Input v-model="mobile1" placeholder="手机号查询" style="width: 218px"
              /></Col>
              <Col span="">
                <Input v-model="userName" placeholder="姓名查询" style="width: 218px"
              /></Col>
              <Col span="">
            ...
            <Row :gutter="10" index="" style="margin-top: 20px">
              <Col span="">
                <Input v-model="userId" placeholder="寄卖商编码查询" style="width: 218px"
              /></Col>
              <Col span="">
